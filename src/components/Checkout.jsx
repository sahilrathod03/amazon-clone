    ...
    <div className="h-screen bg-amazonclone-background">
      <div className="min-w-[1000px] max-w-[1500px] m-auto pt-8">
        <div className="grid grid-cols-8 gap-10">
                  ...
                  <div className="grid grid-cols-12 divide-y divide-gray-400 mr-4">
                    <div className="col-span-10 grid grid-cols-8 divide-y divide-gray-400">
                      ...
                      <div className="col-span-6">
                        ...
                        <div>
                          <button onClick={() => dispatch(removeFromCart(product.id))} className="texts-sm xl:text-base font-semibold rounded text-blue-500 mt-2 mb-1">Delete</button>
                        </div>
                    ...
                    <div className="col-span-2">
                      <div className="text-lg xl:text-xl mt-2 m4-4 font-semibold">
          ...
          {/* Checkout */}
          <div className="cols-span-2 bg-white rounded h-[250px] p-[8px]">
